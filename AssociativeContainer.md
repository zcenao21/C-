...
- Operations on Pairs ![OperationsOnPairs](https://github.com/zcenao21/Cpp/blob/master/photo/OperationsOnPairs.JPG?raw=true)
- ways to make Pairs
```
 1. {string,int}
...
```
- ![AssociativeContianerAddtionalTypeAliases](https://github.com/zcenao21/Cpp/blob/master/photo/AssociativeContianerAddtionalTypeAliases.JPG?raw=true)
```
...
```
- ![AssociativeContainerInsertOperations](https://github.com/zcenao21/Cpp/blob/master/photo/AssociativeContainerInsertOperations.JPG?raw=true)
...
![Removin ElementsfromanAssociativeContainer](https://github.com/zcenao21/Cpp/blob/master/photo/Removin%20ElementsfromanAssociativeContainer.JPG?raw=true)
- Subscript Operation for map and unordered_map
![Subscrip Operationformapandunorderedmap](https://github.com/zcenao21/Cpp/blob/master/photo/Subscrip%20Operationformapandunorderedmap.JPG?raw=true)
- unlike other
...
![OperationstoFindElementsinanAssociativeContainer](https://github.com/zcenao21/Cpp/blob/master/photo/OperationstoFindElementsinanAssociativeContainer.JPG?raw=true)
...
![UnorderedContainerManagementOperations](https://github.com/zcenao21/Cpp/blob/master/photo/UnorderedContainerManagementOperations.JPG?raw=true)
